...
// Helper to detect and wrap URLs in anchor tags
...
// Helper to detect Calendly links
function getCalendlyUrl(text: string): string | null {
  const match = text.match(/https?:\/\/(?:www\.)?calendly\.com\/[^\s]+/);
    ...
    <div className="flex flex-col h-[600px] bg-charcoal-900 rounded-xl border border-charcoal-800 shadow-xl">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4">
        {messages.map((message) => {
          const calendlyUrl = message.sender === "ben" ? getCalendlyUrl(message.text) : null;
          ...
          return (
            ...
            >
              ...
              >
                ...
                {calendlyUrl && (
                  <button
                    className="mt-3 inline-flex items-center justify-center rounded-lg bg-emerald-500 px-5 py-2.5 text-sm font-semibold text-black hover:bg-emerald-400 transition-colors w-full"
